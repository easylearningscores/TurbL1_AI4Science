...
# ============== Data loader ==============
from dataloader_Forced_Li import *

train_dataset = CustomDataset(data_config, split_type='train')
val_dataset = CustomDataset(data_config, split_type='val') 
test_dataset = CustomDataset(data_config, split_type='test')
